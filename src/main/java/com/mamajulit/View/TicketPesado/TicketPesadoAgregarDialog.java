...
public class TicketPesadoAgregarDialog extends JDialog {
    ...
    private void guardarTicket() {
        ...
        try {
            fechaSalida = LocalDate.parse(txtFechaSalida.getText());
        } catch(DateTimeParseException e) {
            errores.append("Fecha salida inválida (usar formato YYYY-MM-DD).\n");
        }
        try {
            fechaIngreso = LocalDate.parse(txtFechaIngreso.getText());
        } catch(DateTimeParseException e) {
            errores.append("Fecha ingreso inválida (usar formato YYYY-MM-DD).\n");
        }
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "Error al agregar ticket: " + e.getMessage());
        }
    }
}
