...
import com.mamajulit.Controller.Dashboard.AdministradorDashboardController;
...
public class AdministradorDashboardView extends JFrame {
    ...
    public AdministradorDashboardView(String nombreUsuario) {
        // Configuración general
        setTitle("Panel Administrador - Mama Julita");
        setSize(1280, 760);
        ...
        controller = new AdministradorDashboardController(this);
        ...
        JLabel titulo = new JLabel("Panel Administrador", SwingConstants.LEFT);
        titulo.setFont(new Font("Segoe UI", Font.BOLD, 18));
        titulo.setForeground(new Color(25, 42, 86));
        titulo.setBorder(BorderFactory.createEmptyBorder(0, 25, 0, 0));

        JLabel rolLabel = new JLabel("Acceso total al sistema", SwingConstants.RIGHT);
        ...
        JLabel bienvenida = new JLabel("Bienvenido al Panel Administrador");
        ...
        JLabel descripcion = new JLabel(
                "<html><div style='text-align:center;'>Administra todos los módulos del sistema Mama Julita,<br>incluyendo usuarios, inventarios, compras y reportes globales.</div></html>");
